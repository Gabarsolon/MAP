            ...
            */
            ...
            IStmt switchEx =
                ...
                new CompStmt(new SwitchStmt(
                                 new ArithExp(3, new VarExp("a"), new ValueExp(new IntValue(10))),
            ...
            try {
                switchEx.typecheck(new MyDictionary<>());
                prg11 = new PrgState(new MyStack<IStmt>(), new MyDictionary<String, Value>(),
                        new MyList<Value>(), new MyDictionary<String, BufferedReader>(), new MyHeap<Integer, Value>(), switchEx);
            } catch (Exception e) {
                System.out.println("switchEx: " + e);
                prg11 = null;
            }
            ...
            List<IStmt> prgList = Arrays.asList(ex1, ex2, ex3, fileOperationsEx, heapAllocationEx, heapReadingEx,
                    heapWritingEx, garbageCollectorEx, whileStmtEx, concurrentEx, switchEx);
