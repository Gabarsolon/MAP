        ...
        try {
            ...
            */
            ...
            IStmt latchEx =
                ...
                new CompStmt(new allocHeap("v1", new ValueExp(new IntValue(2))),
                new CompStmt(new allocHeap("v2", new ValueExp(new IntValue(3))),
                new CompStmt(new allocHeap("v3", new ValueExp(new IntValue(4))),
                ...
                new CompStmt(new forkStmt(
                            ...
                            new forkStmt(new CompStmt(new writeHeap("v2", new ArithExp(3, new readHeap(new VarExp("v2")), new ValueExp(new IntValue(10)))),
                                                      new CompStmt(new PrintStmt(new readHeap(new VarExp("v2"))),
                                                      new CompStmt(new countDown("cnt"),
                                                      new forkStmt(new CompStmt(new writeHeap("v3", new ArithExp(3, new readHeap(new VarExp("v3")), new ValueExp(new IntValue(10)))),
            ...
            try {
                ...
                prg1 = new PrgState(new MyStack<IStmt>(), new MyDictionary<String, Value>(),
                        new MyList<Value>(), new MyDictionary<String, BufferedReader>(), new MyHeap<Integer, Value>(), new MyLatchTable(), ex1);
            } catch (Exception e) {
            ...
            try {
                ...
                prg2 = new PrgState(new MyStack<IStmt>(), new MyDictionary<String, Value>(),
                        new MyList<Value>(), new MyDictionary<String, BufferedReader>(), new MyHeap<Integer, Value>(), new MyLatchTable(),ex2);
            } catch (Exception e) {
            ...
            try {
                ...
                prg3 = new PrgState(new MyStack<IStmt>(), new MyDictionary<String, Value>(),
                        new MyList<Value>(), new MyDictionary<String, BufferedReader>(), new MyHeap<Integer, Value>(),new MyLatchTable(), ex3);
            } catch (Exception e) {
            ...
            try {
                ...
                prg4 = new PrgState(new MyStack<IStmt>(), new MyDictionary<String, Value>(),
                        new MyList<Value>(), new MyDictionary<String, BufferedReader>(), new MyHeap<Integer, Value>(),new MyLatchTable(), fileOperationsEx);
            } catch (Exception e) {
            ...
            try {
                ...
                prg5 = new PrgState(new MyStack<IStmt>(), new MyDictionary<String, Value>(),
                        new MyList<Value>(), new MyDictionary<String, BufferedReader>(), new MyHeap<Integer, Value>(),new MyLatchTable(), heapAllocationEx);
            } catch (Exception e) {
            ...
            try {
                ...
                prg6 = new PrgState(new MyStack<IStmt>(), new MyDictionary<String, Value>(),
                        new MyList<Value>(), new MyDictionary<String, BufferedReader>(), new MyHeap<Integer, Value>(),new MyLatchTable(), heapReadingEx);
            } catch (Exception e) {
            ...
            try {
                ...
                prg7 = new PrgState(new MyStack<IStmt>(), new MyDictionary<String, Value>(),
                        new MyList<Value>(), new MyDictionary<String, BufferedReader>(), new MyHeap<Integer, Value>(),new MyLatchTable(), heapWritingEx);
            } catch (Exception e) {
            ...
            try {
                ...
                prg8 = new PrgState(new MyStack<IStmt>(), new MyDictionary<String, Value>(),
                        new MyList<Value>(), new MyDictionary<String, BufferedReader>(), new MyHeap<Integer, Value>(),new MyLatchTable(), garbageCollectorEx);
            } catch (Exception e) {
            ...
            try {
                ...
                prg9 = new PrgState(new MyStack<IStmt>(), new MyDictionary<String, Value>(),
                        new MyList<Value>(), new MyDictionary<String, BufferedReader>(), new MyHeap<Integer, Value>(), new MyLatchTable(),whileStmtEx);
            } catch (Exception e) {
            ...
            try {
                ...
                prg10 = new PrgState(new MyStack<IStmt>(), new MyDictionary<String, Value>(),
                        new MyList<Value>(), new MyDictionary<String, BufferedReader>(), new MyHeap<Integer, Value>(),new MyLatchTable(), concurrentEx);
            } catch (Exception e) {
            ...
            try {
                latchEx.typecheck(new MyDictionary<>());
                prg11 = new PrgState(new MyStack<IStmt>(), new MyDictionary<String, Value>(),
                        new MyList<Value>(), new MyDictionary<String, BufferedReader>(), new MyHeap<Integer, Value>(),new MyLatchTable(), latchEx);
            } catch (Exception e) {
                System.out.println("latchEx: " + e);
                prg11 = null;
            }
            ...
            List<IStmt> prgList = Arrays.asList(ex1, ex2, ex3, fileOperationsEx, heapAllocationEx, heapReadingEx,
                    heapWritingEx, garbageCollectorEx, whileStmtEx, concurrentEx, latchEx);
