...
public class InterpreterController {
    ...
    @FXML
    private TableColumn<Map.Entry<Integer, Integer>, String> locationColumnLatchTableView;

    @FXML
    private TableColumn<Map.Entry<Integer, Integer>, String> valueColumnLatchTableView;
    ...
    private void updateProgramsStatus(){
        ...
        latchTableView.getItems().addAll(prgList.get(0).getLatchTable().getData().entrySet());
    ...
    public void initialize(){
        ...
        locationColumnLatchTableView.setCellValueFactory(param->new ReadOnlyStringWrapper(param.getValue().getKey().toString()));
        valueColumnLatchTableView.setCellValueFactory(param->new ReadOnlyStringWrapper(param.getValue().getValue().toString()));
