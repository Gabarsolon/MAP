        ...
        try {
            ...
            */
            ...
            IStmt condAssignEx =
                ...
                new CompStmt(new VarDeclStmt("v", new IntType()),
                new CompStmt(new allocHeap("a", new ValueExp(new IntValue(0))),
                new CompStmt(new allocHeap("b", new ValueExp(new IntValue(0))),
                new CompStmt(new writeHeap("a", new ValueExp(new IntValue(1))),
                new CompStmt(new writeHeap("b", new ValueExp(new IntValue(2))),
                new CompStmt(new CondAssignment("v", new RelExp("<",new readHeap(new VarExp("a")), new readHeap(new VarExp("b"))),
                                                new ValueExp(new IntValue(100)),
                                                new ValueExp(new IntValue(200))),
                new CompStmt(new PrintStmt(new VarExp("v")),
                new CompStmt(new CondAssignment("v", new RelExp(">", new ArithExp(2, new readHeap(new VarExp("b")), new ValueExp(new IntValue(2))),
            ...
            try {
                condAssignEx.typecheck(new MyDictionary<>());
                prg11 = new PrgState(new MyStack<IStmt>(), new MyDictionary<String, Value>(),
                        new MyList<Value>(), new MyDictionary<String, BufferedReader>(), new MyHeap<Integer, Value>(), condAssignEx);
            } catch (Exception e) {
                System.out.println("condAssignEx: " + e);
                prg11 = null;
            }
            ...
            List<IStmt> prgList = Arrays.asList(ex1, ex2, ex3, fileOperationsEx, heapAllocationEx, heapReadingEx,
                    heapWritingEx, garbageCollectorEx, whileStmtEx, concurrentEx, condAssignEx);
